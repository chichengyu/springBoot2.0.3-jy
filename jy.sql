...
Date: 2020-03-04 15:17:34
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for jy_chapter
-- ----------------------------
DROP TABLE IF EXISTS `jy_chapter`;
CREATE TABLE `jy_chapter` (
...
-- ----------------------------
-- Table structure for jy_episode
-- ----------------------------
DROP TABLE IF EXISTS `jy_episode`;
CREATE TABLE `jy_episode` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for jy_video
-- ----------------------------
DROP TABLE IF EXISTS `jy_video`;
CREATE TABLE `jy_video` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for jy_video_order
-- ----------------------------
DROP TABLE IF EXISTS `jy_video_order`;
CREATE TABLE `jy_video_order` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
